// Generated from c:/Users/bayro/Desktop/ProyectoCompiladores/src/main/java/Simple.g4 by ANTLR 4.13.1
...
public class SimpleParser extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class FunctionCallExpresionContext extends ExpressionContext {
		public FunctionCallContext functionCall() {
			return getRuleContext(FunctionCallContext.class,0);
		}
		public FunctionCallExpresionContext(ExpressionContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 3:
				{
				_localctx = new FunctionCallExpresionContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(86);
				functionCall();
